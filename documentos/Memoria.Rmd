...
El código fuente está alojado en un repositorio privado de GitHub, al que únicamente tiene acceso el profesor. Se encuentra en el siguiente enlace, bajo el directorio `/source/`: [**GitHub Repository**](https://github.com/juanantoniotora/PR1-WebScraping-TCVD/tree/main).

### Estructura del Directorio de Código Fuente en `/source/`
...
## Detalles del Código en `/source/otras_funciones`
...
## Visión General de las Funcionalidades en `/source/main`
...
## Descripción de Funciones en “/source/main/librerias_propias.py”
...
1. En el repositorio privado de GitHub, con acceso para el profesor de la asignatura: [**Github Repository**](https://github.com/juanantoniotora/PR1-WebScraping-TCVD/tree/main/dataset)
...
Para acceder al video de presentación de la práctica, clic aquí: [**Google Drive**](https://drive.google.com/drive/folders/1EInfbrKzBEe3Lx-FukgP-cQh7qsU0_zV?usp=drive_link)
